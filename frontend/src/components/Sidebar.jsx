...
const Sidebar = ({ isOpen, onClose }) => {
  ...
  const navItems = [
    ...
    { label: 'Upload Document', path: '/upload', icon: UploadCloud },
    { label: 'Document History', path: '/history', icon: FileSpreadsheet },
    { label: 'AI Document Chat', path: '/chat', icon: MessageSquareCode },
        ...
        <div className="p-4 space-y-1 overflow-y-auto h-full flex flex-col justify-between">
          ...
          <div className="p-3.5 rounded-xl bg-slate-100/80 dark:bg-slate-800/50 border border-slate-200/50 dark:border-slate-700/50 mt-6">
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400">
              Gemini 1.5 Flash & Tesseract OCR active.
            </p>
          </div>
        </div>
      </aside>
